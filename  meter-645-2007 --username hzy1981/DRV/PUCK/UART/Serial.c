...
INT8U UART0_RecData_pre_PUCK(void)
{
  ...
  memset((INT8U *)Uart0_RecBuf,0x00,sizeof(Uart0_RecBuf));
  return 1;
}
...
INT8U UART2_RecData_pre_PUCK(void)
{
  ...
  memset((INT8U *)Uart2_RecBuf,0x00,sizeof(Uart2_RecBuf));
  return 1;
}
...
INT8U UART3_RecData_pre_PUCK(void)
{
  ...
  memset((INT8U *)Uart3_RecBuf,0x00,sizeof(Uart3_RecBuf));
  return 1;
}

...
#define HEX2BCD_4B(X) ((INT32U)(X)%10 + ((((INT32U)(X)/10)%10) << 4) + \
                       ...
                       ((((INT32U)(X)/1000000)%10) << 24) + ((((INT32U)(X)/10000000)%10) << 28))
...
{
  BYTE_0(HEX2BCD_4B(UB*11/10)),BYTE_1(HEX2BCD_4B(UB*11/10)),//0x40,0x26, //264V
  BYTE_0(HEX2BCD_4B(UB*9/10)),BYTE_1(HEX2BCD_4B(UB*9/10))//0x80,0x19 //198V
...
{
  BYTE_0(HEX2BCD_4B(UB*78/100)),BYTE_1(HEX2BCD_4B(UB*78/100)),//0x16,0x17, //171.6
  BYTE_0(HEX2BCD_4B(UB*85/100)),BYTE_1(HEX2BCD_4B(UB*85/100)),//0x70,0x18  //187.0
};
...
{
  BYTE_0(HEX2BCD_4B(UB*90/100)),BYTE_1(HEX2BCD_4B(UB*90/100))//0x80,0x19 //198.0V
};
...
{
  BYTE_0(HEX2BCD_4B(UB*120/100)),BYTE_1(HEX2BCD_4B(UB*120/100)),//0x40,0x26 //264.0V，120%
};
...
{
  BYTE_0(HEX2BCD_4B(UB*60/100)), BYTE_1(HEX2BCD_4B(UB*60/100)),//132.0V
};
...
{
  BYTE_0(HEX2BCD_4B(UB*60/100)),BYTE_1(HEX2BCD_4B(UB*60/100))//0x20,0x13 //132V,UB*60%
};
...
{
  BYTE_0(HEX2BCD_4B(UB*90/100)),BYTE_1(HEX2BCD_4B(UB*90/100))//0x80,0x19 //198.0V，90%UB
};
...
{
  BYTE_0(HEX2BCD_4B(PB/1000)), BYTE_1(HEX2BCD_4B(PB/1000)),BYTE_2(HEX2BCD_4B(PB/1000)),//0x30,0x03,0x00 //0.033kw,10%PB
};
...
{
  BYTE_0(HEX2BCD_4B(PMAX*12/1000)), BYTE_1(HEX2BCD_4B(PMAX*12/1000)),BYTE_2(HEX2BCD_4B(PMAX*12/1000))//0x40,0x58,0x01 //1.584kw,120%PMAX
};
...
{
  BYTE_0(HEX2BCD_4B(UB*12/10)),BYTE_1(HEX2BCD_4B(UB*12/10)),//0x40,0x26, //264V
  BYTE_0(HEX2BCD_4B(UB*8/10)),BYTE_1(HEX2BCD_4B(UB*8/10))//0x80,0x19 //198V
};

//有、无功需量超下限
CONST INT8U Def_04090D01_2[]=
{
  BYTE_0(HEX2BCD_4B(PMAX*30/1000)), BYTE_1(HEX2BCD_4B(PMAX*30/1000)),BYTE_2(HEX2BCD_4B(PMAX*30/1000)),//0x00,0x96,0x03, //3.96kw
  BYTE_0(HEX2BCD_4B(PMAX*30/1000)), BYTE_1(HEX2BCD_4B(PMAX*30/1000)),BYTE_2(HEX2BCD_4B(PMAX*30/1000))//0x00,0x90,0x03 //3.90kw
};
